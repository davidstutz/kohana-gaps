 ...
 */
class Gaps_DriverTextareaTest extends Unittest_TestCase {
    ...
    public function test_load($field, $post, $expected) {
        $driver = new Gaps_Driver_Textarea($field, array(), $this->_model);
    ...
    public function test_render($options) {
        $driver = new Gaps_Driver_Textarea('field', $options, $this->_model);
        $driver->render();
    }
}